; ModuleID = 'C:/Users/Alpheus/enhancedhls/AXISEnhanced/AXISEnhanced_Soln/.autopilot/db/a.g.1.bc'
...
@AXISEnhanced.str = internal unnamed_addr constant [13 x i8] c"AXISEnhanced\00" ; [#uses=1 type=[13 x i8]*]
...
define internal fastcc i32 @mul(i16 signext %a, i16 signext %b) nounwind {
  call void @llvm.dbg.value(metadata !{i16 %a}, i64 0, metadata !133), !dbg !134 ; [debug line = 166:17] [debug variable = a]
  call void @llvm.dbg.value(metadata !{i16 %b}, i64 0, metadata !135), !dbg !136 ; [debug line = 166:28] [debug variable = b]
  %tmp = sext i16 %a to i32, !dbg !137            ; [#uses=1 type=i32] [debug line = 167:5]
  %tmp.1 = sext i16 %b to i32, !dbg !137          ; [#uses=1 type=i32] [debug line = 167:5]
  %tmp.2 = mul nsw i32 %tmp.1, %tmp, !dbg !137    ; [#uses=1 type=i32] [debug line = 167:5]
  %tmp.3 = ashr i32 %tmp.2, 8, !dbg !137          ; [#uses=1 type=i32] [debug line = 167:5]
  ret i32 %tmp.3, !dbg !137                       ; [debug line = 167:5]
}
...
; [#uses=0]
define void @AXISEnhanced(%"class.hls::stream.1"* %S_AXIS, %"class.hls::stream.1"* %M_AXIS) nounwind {
  call void (...)* @_ssdm_op_SpecTopModule([13 x i8]* @AXISEnhanced.str) nounwind
  ...
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.1"* %S_AXIS}, i64 0, metadata !139), !dbg !140 ; [debug line = 44:44] [debug variable = S_AXIS]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.1"* %M_AXIS}, i64 0, metadata !141), !dbg !142 ; [debug line = 44:77] [debug variable = M_AXIS]
...
; <label>:5                                       ; preds = %3
  %rend28 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([14 x i8]* @.str4, i32 0, i32 0), i32 %rbegin1) nounwind, !dbg !178 ; [#uses=0 type=i32] [debug line = 61:2]
...
; <label>:9                                       ; preds = %7
  %rend26 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([14 x i8]* @.str5, i32 0, i32 0), i32 %rbegin2) nounwind, !dbg !188 ; [#uses=0 type=i32] [debug line = 68:2]
...
; <label>:10                                      ; preds = %.preheader18
  ...
  %.addr.4 = getelementptr inbounds %struct.AXIS_wLAST.0* %tmp.12, i32 0, i32 0, !dbg !198 ; [#uses=1 type=i32*] [debug line = 123:17]
  %.addr.5 = getelementptr inbounds %struct.AXIS_wLAST.0* %tmp.12, i32 0, i32 1, !dbg !198 ; [#uses=1 type=i1*] [debug line = 123:17]
  %tmp.i1.addr = getelementptr inbounds %struct.AXIS_wLAST.0* %tmp.15, i32 0, i32 0, !dbg !203 ; [#uses=1 type=i32*] [debug line = 145:31@162:3]
  %tmp.i1.addr.1 = getelementptr inbounds %struct.AXIS_wLAST.0* %tmp.15, i32 0, i32 1, !dbg !203 ; [#uses=1 type=i1*] [debug line = 145:31@162:3]
  br label %11, !dbg !205                         ; [debug line = 120:21]
...
; <label>:11                                      ; preds = %32, %10
  ...
  %exitcond4 = icmp eq i32 %k, 36, !dbg !205      ; [#uses=1 type=i1] [debug line = 120:21]
  br i1 %exitcond4, label %33, label %12, !dbg !205 ; [debug line = 120:21]

; <label>:12                                      ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !206 ; [debug line = 120:41]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !206 ; [#uses=1 type=i32] [debug line = 120:41]
  br label %13, !dbg !207                         ; [debug line = 122:8]

; <label>:13                                      ; preds = %14, %12
  %i.2 = phi i32 [ 0, %12 ], [ %i.7, %14 ]        ; [#uses=3 type=i32]
  %exitcond6 = icmp eq i32 %i.2, 13, !dbg !207    ; [#uses=1 type=i1] [debug line = 122:8]
  br i1 %exitcond6, label %.preheader17.preheader, label %14, !dbg !207 ; [debug line = 122:8]

.preheader17.preheader:                           ; preds = %13
  br label %.preheader17, !dbg !208               ; [debug line = 127:28]

; <label>:14                                      ; preds = %13
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.1"* %S_AXIS}, i64 0, metadata !163), !dbg !210 ; [debug line = 129:56@123:17] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.AXIS_wLAST.0* %tmp.12}, metadata !166) nounwind, !dbg !211 ; [debug line = 130:22@123:17] [debug variable = tmp]
  call void @"_ssdm_op_IfRead.Stream.%struct.AXIS_wLAST.0 = type { i32, i1 }P.%struct.AXIS_wLAST.0 = type { i32, i1 }P"(%struct.AXIS_wLAST.0* %S_AXIS.addr, %struct.AXIS_wLAST.0* %tmp.12) nounwind, !dbg !212 ; [debug line = 131:9@123:17]
  %read_input.data.2 = load i32* %.addr.4, align 4, !dbg !198 ; [#uses=2 type=i32] [debug line = 123:17]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %read_input.data.2) nounwind
  call void @llvm.dbg.value(metadata !{i32 %read_input.data.2}, i64 0, metadata !168), !dbg !198 ; [debug line = 123:17] [debug variable = read_input.data]
  %read_input.last.2 = load i1* %.addr.5, align 4, !dbg !198 ; [#uses=1 type=i1] [debug line = 123:17]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %read_input.last.2) nounwind
  call void @llvm.dbg.value(metadata !{i1 %read_input.last.2}, i64 0, metadata !172), !dbg !198 ; [debug line = 123:17] [debug variable = read_input.last]
  %tmp.13 = trunc i32 %read_input.data.2 to i16, !dbg !213 ; [#uses=1 type=i16] [debug line = 124:4]
  %test_data.addr = getelementptr inbounds [13 x i16]* @test_data, i32 0, i32 %i.2, !dbg !213 ; [#uses=1 type=i16*] [debug line = 124:4]
  store i16 %tmp.13, i16* %test_data.addr, align 2, !dbg !213 ; [debug line = 124:4]
  %i.7 = add nsw i32 %i.2, 1, !dbg !214           ; [#uses=1 type=i32] [debug line = 122:23]
  call void @llvm.dbg.value(metadata !{i32 %i.7}, i64 0, metadata !180), !dbg !214 ; [debug line = 122:23] [debug variable = i]
  br label %13, !dbg !214                         ; [debug line = 122:23]

.preheader17:                                     ; preds = %22, %.preheader17.preheader
  %i.3 = phi i32 [ %i.8, %22 ], [ 0, %.preheader17.preheader ] ; [#uses=4 type=i32]
  %exitcond7 = icmp eq i32 %i.3, 5, !dbg !208     ; [#uses=1 type=i1] [debug line = 127:28]
  br i1 %exitcond7, label %.preheader.preheader, label %15, !dbg !208 ; [debug line = 127:28]

.preheader.preheader:                             ; preds = %.preheader17
  br label %.preheader, !dbg !215                 ; [debug line = 141:28]

; <label>:15                                      ; preds = %.preheader17
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([20 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !217 ; [debug line = 127:47]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([20 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !217 ; [#uses=1 type=i32] [debug line = 127:47]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !219 ; [debug line = 128:1]
  %values_hidden_layer.addr = getelementptr inbounds [5 x i16]* @values_hidden_layer, i32 0, i32 %i.3, !dbg !220 ; [#uses=8 type=i16*] [debug line = 128:4]
  store i16 0, i16* %values_hidden_layer.addr, align 2, !dbg !220 ; [debug line = 128:4]
  br label %16, !dbg !221                         ; [debug line = 129:9]

; <label>:16                                      ; preds = %17, %15
  %j.2 = phi i32 [ 0, %15 ], [ %j.6, %17 ]        ; [#uses=4 type=i32]
  %exitcond9 = icmp eq i32 %j.2, 13, !dbg !221    ; [#uses=1 type=i1] [debug line = 129:9]
  br i1 %exitcond9, label %18, label %17, !dbg !221 ; [debug line = 129:9]

; <label>:17                                      ; preds = %16
  %test_data.addr.1 = getelementptr inbounds [13 x i16]* @test_data, i32 0, i32 %j.2, !dbg !223 ; [#uses=1 type=i16*] [debug line = 130:31]
  %test_data.load = load i16* %test_data.addr.1, align 2, !dbg !223 ; [#uses=2 type=i16] [debug line = 130:31]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %test_data.load) nounwind
  %weights_IH.addr.1 = getelementptr inbounds [13 x [5 x i16]]* @weights_IH, i32 0, i32 %j.2, i32 %i.3, !dbg !223 ; [#uses=1 type=i16*] [debug line = 130:31]
  %weights_IH.load = load i16* %weights_IH.addr.1, align 2, !dbg !223 ; [#uses=2 type=i16] [debug line = 130:31]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %weights_IH.load) nounwind
  %tmp.18 = call fastcc i32 @mul(i16 signext %test_data.load, i16 signext %weights_IH.load), !dbg !223 ; [#uses=1 type=i32] [debug line = 130:31]
  %values_hidden_layer.load.1 = load i16* %values_hidden_layer.addr, align 2, !dbg !223 ; [#uses=2 type=i16] [debug line = 130:31]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %values_hidden_layer.load.1) nounwind
  %tmp.19 = trunc i32 %tmp.18 to i16, !dbg !223   ; [#uses=1 type=i16] [debug line = 130:31]
  %tmp.20 = add i16 %values_hidden_layer.load.1, %tmp.19, !dbg !223 ; [#uses=1 type=i16] [debug line = 130:31]
  store i16 %tmp.20, i16* %values_hidden_layer.addr, align 2, !dbg !223 ; [debug line = 130:31]
  %j.6 = add nsw i32 %j.2, 1, !dbg !225           ; [#uses=1 type=i32] [debug line = 129:24]
  call void @llvm.dbg.value(metadata !{i32 %j.6}, i64 0, metadata !177), !dbg !225 ; [debug line = 129:24] [debug variable = j]
  br label %16, !dbg !225                         ; [debug line = 129:24]

; <label>:18                                      ; preds = %16
  %values_hidden_layer.load = load i16* %values_hidden_layer.addr, align 2, !dbg !226 ; [#uses=4 type=i16] [debug line = 132:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %values_hidden_layer.load) nounwind
  %tmp.17 = icmp slt i16 %values_hidden_layer.load, -1024, !dbg !226 ; [#uses=1 type=i1] [debug line = 132:4]
  br i1 %tmp.17, label %19, label %20, !dbg !226  ; [debug line = 132:4]

; <label>:19                                      ; preds = %18
  store i16 -1024, i16* %values_hidden_layer.addr, align 2, !dbg !227 ; [debug line = 133:7]
  br label %22, !dbg !229                         ; [debug line = 134:4]

; <label>:20                                      ; preds = %18
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %values_hidden_layer.load) nounwind
  %tmp.22 = icmp sgt i16 %values_hidden_layer.load, 1023, !dbg !230 ; [#uses=1 type=i1] [debug line = 134:11]
  br i1 %tmp.22, label %21, label %._crit_edge, !dbg !230 ; [debug line = 134:11]

; <label>:21                                      ; preds = %20
  store i16 1023, i16* %values_hidden_layer.addr, align 2, !dbg !231 ; [debug line = 135:5]
  br label %._crit_edge, !dbg !233                ; [debug line = 136:4]

._crit_edge:                                      ; preds = %21, %20
  br label %22

; <label>:22                                      ; preds = %._crit_edge, %19
  %values_hidden_layer.load.3 = load i16* %values_hidden_layer.addr, align 2, !dbg !234 ; [#uses=2 type=i16] [debug line = 137:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %values_hidden_layer.load.3) nounwind
  %tmp.29 = sext i16 %values_hidden_layer.load.3 to i32, !dbg !234 ; [#uses=1 type=i32] [debug line = 137:4]
  %tmp.30 = add nsw i32 %tmp.29, 1024, !dbg !234  ; [#uses=1 type=i32] [debug line = 137:4]
  %sigmoid_arr.addr = getelementptr inbounds [2048 x i32]* @sigmoid_arr, i32 0, i32 %tmp.30, !dbg !234 ; [#uses=1 type=i32*] [debug line = 137:4]
  %sigmoid_arr.load = load i32* %sigmoid_arr.addr, align 4, !dbg !234 ; [#uses=2 type=i32] [debug line = 137:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %sigmoid_arr.load) nounwind
  %tmp.31 = trunc i32 %sigmoid_arr.load to i16, !dbg !234 ; [#uses=1 type=i16] [debug line = 137:4]
  store i16 %tmp.31, i16* %values_hidden_layer.addr, align 2, !dbg !234 ; [debug line = 137:4]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([20 x i8]* @.str7, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !235 ; [#uses=0 type=i32] [debug line = 138:3]
  %i.8 = add nsw i32 %i.3, 1, !dbg !236           ; [#uses=1 type=i32] [debug line = 127:42]
  call void @llvm.dbg.value(metadata !{i32 %i.8}, i64 0, metadata !180), !dbg !236 ; [debug line = 127:42] [debug variable = i]
  br label %.preheader17, !dbg !236               ; [debug line = 127:42]
...
.preheader:                                       ; preds = %._crit_edge20, %.preheader.preheader
  ...
  %exitcond8 = icmp eq i32 %i.4, 3, !dbg !215     ; [#uses=1 type=i1] [debug line = 141:28]
  br i1 %exitcond8, label %32, label %23, !dbg !215 ; [debug line = 141:28]

; <label>:23                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([20 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !237 ; [debug line = 141:47]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([20 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !237 ; [#uses=1 type=i32] [debug line = 141:47]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !239 ; [debug line = 142:1]
  %values_output_layer.addr = getelementptr inbounds [3 x i16]* @values_output_layer, i32 0, i32 %i.4, !dbg !240 ; [#uses=8 type=i16*] [debug line = 142:4]
  store i16 0, i16* %values_output_layer.addr, align 2, !dbg !240 ; [debug line = 142:4]
  br label %24, !dbg !241                         ; [debug line = 143:9]

; <label>:24                                      ; preds = %25, %23
  %j.3 = phi i32 [ 0, %23 ], [ %j.7, %25 ]        ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %j.3, 5, !dbg !241      ; [#uses=1 type=i1] [debug line = 143:9]
  br i1 %exitcond, label %26, label %25, !dbg !241 ; [debug line = 143:9]

; <label>:25                                      ; preds = %24
  %values_hidden_layer.addr.1 = getelementptr inbounds [5 x i16]* @values_hidden_layer, i32 0, i32 %j.3, !dbg !243 ; [#uses=1 type=i16*] [debug line = 144:31]
  %values_hidden_layer.load.2 = load i16* %values_hidden_layer.addr.1, align 2, !dbg !243 ; [#uses=2 type=i16] [debug line = 144:31]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %values_hidden_layer.load.2) nounwind
  %weights_HO.addr.1 = getelementptr inbounds [5 x [3 x i16]]* @weights_HO, i32 0, i32 %j.3, i32 %i.4, !dbg !243 ; [#uses=1 type=i16*] [debug line = 144:31]
  %weights_HO.load = load i16* %weights_HO.addr.1, align 2, !dbg !243 ; [#uses=2 type=i16] [debug line = 144:31]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %weights_HO.load) nounwind
  %tmp.24 = call fastcc i32 @mul(i16 signext %values_hidden_layer.load.2, i16 signext %weights_HO.load), !dbg !243 ; [#uses=1 type=i32] [debug line = 144:31]
  %values_output_layer.load.1 = load i16* %values_output_layer.addr, align 2, !dbg !243 ; [#uses=2 type=i16] [debug line = 144:31]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %values_output_layer.load.1) nounwind
  %tmp.25 = trunc i32 %tmp.24 to i16, !dbg !243   ; [#uses=1 type=i16] [debug line = 144:31]
  %tmp.26 = add i16 %values_output_layer.load.1, %tmp.25, !dbg !243 ; [#uses=1 type=i16] [debug line = 144:31]
  store i16 %tmp.26, i16* %values_output_layer.addr, align 2, !dbg !243 ; [debug line = 144:31]
  %j.7 = add nsw i32 %j.3, 1, !dbg !245           ; [#uses=1 type=i32] [debug line = 143:23]
  call void @llvm.dbg.value(metadata !{i32 %j.7}, i64 0, metadata !177), !dbg !245 ; [debug line = 143:23] [debug variable = j]
  br label %24, !dbg !245                         ; [debug line = 143:23]

; <label>:26                                      ; preds = %24
  %values_output_layer.load = load i16* %values_output_layer.addr, align 2, !dbg !246 ; [#uses=4 type=i16] [debug line = 146:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %values_output_layer.load) nounwind
  %tmp.23 = icmp slt i16 %values_output_layer.load, -1024, !dbg !246 ; [#uses=1 type=i1] [debug line = 146:4]
  br i1 %tmp.23, label %27, label %28, !dbg !246  ; [debug line = 146:4]

; <label>:27                                      ; preds = %26
  store i16 -1024, i16* %values_output_layer.addr, align 2, !dbg !247 ; [debug line = 147:5]
  br label %30, !dbg !249                         ; [debug line = 148:4]

; <label>:28                                      ; preds = %26
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %values_output_layer.load) nounwind
  %tmp.28 = icmp sgt i16 %values_output_layer.load, 1023, !dbg !250 ; [#uses=1 type=i1] [debug line = 148:11]
  br i1 %tmp.28, label %29, label %._crit_edge19, !dbg !250 ; [debug line = 148:11]

; <label>:29                                      ; preds = %28
  store i16 1023, i16* %values_output_layer.addr, align 2, !dbg !251 ; [debug line = 149:5]
  br label %._crit_edge19, !dbg !253              ; [debug line = 150:4]

._crit_edge19:                                    ; preds = %29, %28
  br label %30

; <label>:30                                      ; preds = %._crit_edge19, %27
  %values_output_layer.load.2 = load i16* %values_output_layer.addr, align 2, !dbg !254 ; [#uses=2 type=i16] [debug line = 151:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %values_output_layer.load.2) nounwind
  %tmp.33 = sext i16 %values_output_layer.load.2 to i32, !dbg !254 ; [#uses=1 type=i32] [debug line = 151:4]
  %tmp.34 = add nsw i32 %tmp.33, 1024, !dbg !254  ; [#uses=1 type=i32] [debug line = 151:4]
  %sigmoid_arr.addr.1 = getelementptr inbounds [2048 x i32]* @sigmoid_arr, i32 0, i32 %tmp.34, !dbg !254 ; [#uses=1 type=i32*] [debug line = 151:4]
  %sigmoid_arr.load.1 = load i32* %sigmoid_arr.addr.1, align 4, !dbg !254 ; [#uses=2 type=i32] [debug line = 151:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %sigmoid_arr.load.1) nounwind
  %highest_pred.2 = trunc i32 %sigmoid_arr.load.1 to i16, !dbg !254 ; [#uses=5 type=i16] [debug line = 151:4]
  store i16 %highest_pred.2, i16* %values_output_layer.addr, align 2, !dbg !254 ; [debug line = 151:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %highest_pred.2) nounwind
  %tmp.36 = icmp sgt i16 %highest_pred.2, %highest_pred, !dbg !255 ; [#uses=1 type=i1] [debug line = 152:4]
  br i1 %tmp.36, label %31, label %._crit_edge20, !dbg !255 ; [debug line = 152:4]

; <label>:31                                      ; preds = %30
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %highest_pred.2) nounwind
  call void @llvm.dbg.value(metadata !{i16 %highest_pred.2}, i64 0, metadata !256), !dbg !257 ; [debug line = 153:5] [debug variable = highest_pred]
  %prediction = add nsw i32 %i.4, 1, !dbg !259    ; [#uses=1 type=i32] [debug line = 154:5]
  call void @llvm.dbg.value(metadata !{i32 %prediction}, i64 0, metadata !260), !dbg !259 ; [debug line = 154:5] [debug variable = prediction]
  br label %._crit_edge20, !dbg !261              ; [debug line = 155:4]
...
._crit_edge20:                                    ; preds = %31, %30
  ...
  %rend22 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([20 x i8]* @.str8, i32 0, i32 0), i32 %rbegin4) nounwind, !dbg !262 ; [#uses=0 type=i32] [debug line = 156:3]
  %i.9 = add nsw i32 %i.4, 1, !dbg !263           ; [#uses=1 type=i32] [debug line = 141:42]
  call void @llvm.dbg.value(metadata !{i32 %i.9}, i64 0, metadata !180), !dbg !263 ; [debug line = 141:42] [debug variable = i]
  br label %.preheader, !dbg !263                 ; [debug line = 141:42]

; <label>:32                                      ; preds = %.preheader
  %prediction.1.lcssa = phi i32 [ %write_output.data, %.preheader ] ; [#uses=2 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %write_output.data}, i64 0, metadata !264), !dbg !266 ; [debug line = 157:3] [debug variable = write_output.data]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.1"* %M_AXIS}, i64 0, metadata !190), !dbg !267 ; [debug line = 144:48@162:3] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.AXIS_wLAST.0* %tmp.15}, metadata !193) nounwind, !dbg !268 ; [debug line = 145:22@162:3] [debug variable = tmp]
  store i32 %prediction.1.lcssa, i32* %tmp.i1.addr, align 4, !dbg !203 ; [debug line = 145:31@162:3]
  store i1 true, i1* %tmp.i1.addr.1, align 4, !dbg !203 ; [debug line = 145:31@162:3]
  call void @"_ssdm_op_IfWrite.Stream.%struct.AXIS_wLAST.0 = type { i32, i1 }P.%struct.AXIS_wLAST.0 = type { i32, i1 }P"(%struct.AXIS_wLAST.0* %M_AXIS.addr, %struct.AXIS_wLAST.0* %tmp.15) nounwind, !dbg !269 ; [debug line = 146:9@162:3]
  %rend24 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str6, i32 0, i32 0), i32 %rbegin3) nounwind, !dbg !270 ; [#uses=0 type=i32] [debug line = 163:2]
  %k.1 = add nsw i32 %k, 1, !dbg !271             ; [#uses=1 type=i32] [debug line = 120:36]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !272), !dbg !271 ; [debug line = 120:36] [debug variable = k]
  br label %11, !dbg !271                         ; [debug line = 120:36]

; <label>:33                                      ; preds = %11
  ret void, !dbg !273                             ; [debug line = 164:1]
}
...
!80 = metadata !{i32 786478, i32 0, metadata !6, metadata !"mul", metadata !"mul", metadata !"_Z3mulss", metadata !6, i32 166, metadata !81, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i16, i16)* @mul, null, null, metadata !25, i32 166} ; [ DW_TAG_subprogram ]
...
!111 = metadata !{void (%"class.hls::stream.1"*, %"class.hls::stream.1"*)* @AXISEnhanced, metadata !112, metadata !113, metadata !114, metadata !115, metadata !116, metadata !117}
...
!133 = metadata !{i32 786689, metadata !80, metadata !"a", metadata !6, i32 16777382, metadata !83, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!134 = metadata !{i32 166, i32 17, metadata !80, null}
!135 = metadata !{i32 786689, metadata !80, metadata !"b", metadata !6, i32 33554598, metadata !83, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!136 = metadata !{i32 166, i32 28, metadata !80, null}
!137 = metadata !{i32 167, i32 5, metadata !138, null}
!138 = metadata !{i32 786443, metadata !80, i32 166, i32 30, metadata !6, i32 26} ; [ DW_TAG_lexical_block ]
!139 = metadata !{i32 786689, metadata !5, metadata !"S_AXIS", metadata !6, i32 16777260, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!140 = metadata !{i32 44, i32 44, metadata !5, null}
!141 = metadata !{i32 786689, metadata !5, metadata !"M_AXIS", metadata !6, i32 33554476, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!142 = metadata !{i32 44, i32 77, metadata !5, null}
!143 = metadata !{i32 45, i32 1, metadata !144, null}
!144 = metadata !{i32 786443, metadata !5, i32 44, i32 84, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
...
!198 = metadata !{i32 123, i32 17, metadata !199, null}
!199 = metadata !{i32 786443, metadata !200, i32 122, i32 28, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
!200 = metadata !{i32 786443, metadata !201, i32 122, i32 3, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!201 = metadata !{i32 786443, metadata !202, i32 120, i32 40, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!202 = metadata !{i32 786443, metadata !144, i32 120, i32 17, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!203 = metadata !{i32 145, i32 31, metadata !194, metadata !204}
!204 = metadata !{i32 162, i32 3, metadata !201, null}
!205 = metadata !{i32 120, i32 21, metadata !202, null}
!206 = metadata !{i32 120, i32 41, metadata !201, null}
!207 = metadata !{i32 122, i32 8, metadata !200, null}
!208 = metadata !{i32 127, i32 28, metadata !209, null}
!209 = metadata !{i32 786443, metadata !201, i32 127, i32 23, metadata !6, i32 13} ; [ DW_TAG_lexical_block ]
...
!213 = metadata !{i32 124, i32 4, metadata !199, null}
!214 = metadata !{i32 122, i32 23, metadata !200, null}
!215 = metadata !{i32 141, i32 28, metadata !216, null}
!216 = metadata !{i32 786443, metadata !201, i32 141, i32 23, metadata !6, i32 19} ; [ DW_TAG_lexical_block ]
!217 = metadata !{i32 127, i32 47, metadata !218, null}
!218 = metadata !{i32 786443, metadata !209, i32 127, i32 46, metadata !6, i32 14} ; [ DW_TAG_lexical_block ]
!219 = metadata !{i32 128, i32 1, metadata !218, null}
!220 = metadata !{i32 128, i32 4, metadata !218, null}
!221 = metadata !{i32 129, i32 9, metadata !222, null}
!222 = metadata !{i32 786443, metadata !218, i32 129, i32 4, metadata !6, i32 15} ; [ DW_TAG_lexical_block ]
!223 = metadata !{i32 130, i32 31, metadata !224, null}
!224 = metadata !{i32 786443, metadata !222, i32 129, i32 28, metadata !6, i32 16} ; [ DW_TAG_lexical_block ]
!225 = metadata !{i32 129, i32 24, metadata !222, null}
!226 = metadata !{i32 132, i32 4, metadata !218, null}
!227 = metadata !{i32 133, i32 7, metadata !228, null}
!228 = metadata !{i32 786443, metadata !218, i32 132, i32 40, metadata !6, i32 17} ; [ DW_TAG_lexical_block ]
!229 = metadata !{i32 134, i32 4, metadata !228, null}
!230 = metadata !{i32 134, i32 11, metadata !218, null}
!231 = metadata !{i32 135, i32 5, metadata !232, null}
!232 = metadata !{i32 786443, metadata !218, i32 134, i32 46, metadata !6, i32 18} ; [ DW_TAG_lexical_block ]
!233 = metadata !{i32 136, i32 4, metadata !232, null}
!234 = metadata !{i32 137, i32 4, metadata !218, null}
!235 = metadata !{i32 138, i32 3, metadata !218, null}
!236 = metadata !{i32 127, i32 42, metadata !209, null}
!237 = metadata !{i32 141, i32 47, metadata !238, null}
!238 = metadata !{i32 786443, metadata !216, i32 141, i32 46, metadata !6, i32 20} ; [ DW_TAG_lexical_block ]
!239 = metadata !{i32 142, i32 1, metadata !238, null}
!240 = metadata !{i32 142, i32 4, metadata !238, null}
!241 = metadata !{i32 143, i32 9, metadata !242, null}
!242 = metadata !{i32 786443, metadata !238, i32 143, i32 4, metadata !6, i32 21} ; [ DW_TAG_lexical_block ]
!243 = metadata !{i32 144, i32 31, metadata !244, null}
!244 = metadata !{i32 786443, metadata !242, i32 143, i32 27, metadata !6, i32 22} ; [ DW_TAG_lexical_block ]
!245 = metadata !{i32 143, i32 23, metadata !242, null}
!246 = metadata !{i32 146, i32 4, metadata !238, null}
!247 = metadata !{i32 147, i32 5, metadata !248, null}
!248 = metadata !{i32 786443, metadata !238, i32 146, i32 40, metadata !6, i32 23} ; [ DW_TAG_lexical_block ]
!249 = metadata !{i32 148, i32 4, metadata !248, null}
!250 = metadata !{i32 148, i32 11, metadata !238, null}
!251 = metadata !{i32 149, i32 5, metadata !252, null}
!252 = metadata !{i32 786443, metadata !238, i32 148, i32 46, metadata !6, i32 24} ; [ DW_TAG_lexical_block ]
!253 = metadata !{i32 150, i32 4, metadata !252, null}
!254 = metadata !{i32 151, i32 4, metadata !238, null}
!255 = metadata !{i32 152, i32 4, metadata !238, null}
!256 = metadata !{i32 786688, metadata !144, metadata !"highest_pred", metadata !6, i32 52, metadata !83, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!257 = metadata !{i32 153, i32 5, metadata !258, null}
!258 = metadata !{i32 786443, metadata !238, i32 152, i32 47, metadata !6, i32 25} ; [ DW_TAG_lexical_block ]
!259 = metadata !{i32 154, i32 5, metadata !258, null}
!260 = metadata !{i32 786688, metadata !144, metadata !"prediction", metadata !6, i32 50, metadata !18, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!261 = metadata !{i32 155, i32 4, metadata !258, null}
!262 = metadata !{i32 156, i32 3, metadata !238, null}
!263 = metadata !{i32 141, i32 42, metadata !216, null}
!264 = metadata !{i32 790529, metadata !265, metadata !"write_output.data", null, i32 54, metadata !170, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!265 = metadata !{i32 786688, metadata !144, metadata !"write_output", metadata !6, i32 54, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!266 = metadata !{i32 157, i32 3, metadata !201, null}
!267 = metadata !{i32 144, i32 48, metadata !85, metadata !204}
!268 = metadata !{i32 145, i32 22, metadata !194, metadata !204}
!269 = metadata !{i32 146, i32 9, metadata !194, metadata !204}
!270 = metadata !{i32 163, i32 2, metadata !201, null}
!271 = metadata !{i32 120, i32 36, metadata !202, null}
!272 = metadata !{i32 786688, metadata !144, metadata !"k", metadata !6, i32 49, metadata !18, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!273 = metadata !{i32 164, i32 1, metadata !144, null}
