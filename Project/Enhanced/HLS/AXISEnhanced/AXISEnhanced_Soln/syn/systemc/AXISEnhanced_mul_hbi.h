...
#ifndef __AXISEnhanced_mul_hbi__HH__
#define __AXISEnhanced_mul_hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(AXISEnhanced_mul_hbi) {
    ...
    SC_CTOR(AXISEnhanced_mul_hbi):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
