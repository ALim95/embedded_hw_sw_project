...
entity AXISEnhanced_sigmeOg_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 11; 
...
architecture rtl of AXISEnhanced_sigmeOg_rom is 
...
entity AXISEnhanced_sigmeOg is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of AXISEnhanced_sigmeOg is
    component AXISEnhanced_sigmeOg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    AXISEnhanced_sigmeOg_rom_U :  component AXISEnhanced_sigmeOg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
