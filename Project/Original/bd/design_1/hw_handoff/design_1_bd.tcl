...
proc create_root_design { parentCell } {
  ...
  # Create instance: AXISTry_0, and set properties
  set AXISTry_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:AXISTry:1.0 AXISTry_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net AXISTry_0_M_AXIS [get_bd_intf_pins AXISTry_0/M_AXIS] [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins AXISTry_0/S_AXIS] [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S]
...
preplace inst AXISTry_0 -pg 1 -lvl 2 -y 420 -defaultsOSRD
...
preplace netloc AXISTry_0_M_AXIS 1 2 1 N
