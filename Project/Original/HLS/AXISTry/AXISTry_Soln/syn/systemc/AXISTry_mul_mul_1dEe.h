...
#ifndef __AXISTry_mul_mul_1dEe__HH__
#define __AXISTry_mul_mul_1dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(AXISTry_mul_mul_1dEe) {
    ...
    SC_CTOR(AXISTry_mul_mul_1dEe):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
