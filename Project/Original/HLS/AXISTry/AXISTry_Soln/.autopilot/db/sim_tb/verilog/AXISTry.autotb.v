...
`define AUTOTB_DUT      AXISTry
`define AUTOTB_DUT_INST AESL_inst_AXISTry
`define AUTOTB_TOP      apatb_AXISTry_top
`define AUTOTB_LAT_RESULT_FILE "AXISTry.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "AXISTry.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_AXISTry_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00
`define AUTOTB_II 14565
`define AUTOTB_LATENCY 14564
...
`define AUTOTB_TVIN_S_AXIS_V_data  "./c.AXISTry.autotvin_S_AXIS_V_data.dat"
`define AUTOTB_TVIN_S_AXIS_V_last  "./c.AXISTry.autotvin_S_AXIS_V_last.dat"
`define AUTOTB_TVIN_M_AXIS_V_data  "./c.AXISTry.autotvin_M_AXIS_V_data.dat"
`define AUTOTB_TVIN_M_AXIS_V_last  "./c.AXISTry.autotvin_M_AXIS_V_last.dat"
`define AUTOTB_TVIN_S_AXIS_V_data_out_wrapc  "./rtl.AXISTry.autotvin_S_AXIS_V_data.dat"
`define AUTOTB_TVIN_S_AXIS_V_last_out_wrapc  "./rtl.AXISTry.autotvin_S_AXIS_V_last.dat"
`define AUTOTB_TVIN_M_AXIS_V_data_out_wrapc  "./rtl.AXISTry.autotvin_M_AXIS_V_data.dat"
`define AUTOTB_TVIN_M_AXIS_V_last_out_wrapc  "./rtl.AXISTry.autotvin_M_AXIS_V_last.dat"
`define AUTOTB_TVOUT_M_AXIS_V_data  "./c.AXISTry.autotvout_M_AXIS_V_data.dat"
`define AUTOTB_TVOUT_M_AXIS_V_last  "./c.AXISTry.autotvout_M_AXIS_V_last.dat"
`define AUTOTB_TVOUT_M_AXIS_V_data_out_wrapc  "./impl_rtl.AXISTry.autotvout_M_AXIS_V_data.dat"
`define AUTOTB_TVOUT_M_AXIS_V_last_out_wrapc  "./impl_rtl.AXISTry.autotvout_M_AXIS_V_last.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 14564;
parameter LENGTH_S_AXIS_V_data = 548;
parameter LENGTH_S_AXIS_V_last = 548;
parameter LENGTH_M_AXIS_V_data = 37;
parameter LENGTH_M_AXIS_V_last = 37;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.AXISTry.autotvout_M_AXIS_V_data.dat", "r");
    fp2 = $fopen("./impl_rtl.AXISTry.autotvout_M_AXIS_V_data.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.AXISTry.autotvout_M_AXIS_V_data.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.AXISTry.autotvout_M_AXIS_V_data.dat\"!");
    else begin
        $display("Comparing rtl.AXISTry.autotvout_M_AXIS_V_data.dat with impl_rtl.AXISTry.autotvout_M_AXIS_V_data.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.AXISTry.autotvout_M_AXIS_V_last.dat", "r");
    fp2 = $fopen("./impl_rtl.AXISTry.autotvout_M_AXIS_V_last.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.AXISTry.autotvout_M_AXIS_V_last.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.AXISTry.autotvout_M_AXIS_V_last.dat\"!");
    else begin
        $display("Comparing rtl.AXISTry.autotvout_M_AXIS_V_last.dat with impl_rtl.AXISTry.autotvout_M_AXIS_V_last.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
begin
    ...
    `define STREAM_SIZE_IN_S_AXIS_V_data "./stream_size_in_S_AXIS_V_data.dat"
    ...
    `define STREAM_SIZE_OUT_M_AXIS_V_data "./stream_size_out_M_AXIS_V_data.dat"
    ...
    `define STREAM_SIZE_OUT_M_AXIS_V_last "./stream_size_out_M_AXIS_V_last.dat"
