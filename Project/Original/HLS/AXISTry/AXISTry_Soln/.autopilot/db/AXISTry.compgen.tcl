...
set ID 2
set MemName AXISTry_weights_IH
...
# Memory (RAM/ROM)  definition:
set ID 3
set MemName AXISTry_weights_HO
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 15
...
# Memory (RAM/ROM)  definition:
set ID 5
set MemName AXISTry_values_hibkb
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 5
...
# Memory (RAM/ROM)  definition:
set ID 6
set MemName AXISTry_sigmoid_arr
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 2048
...
# Memory (RAM/ROM)  definition:
set ID 7
set MemName AXISTry_values_oucud
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 3
