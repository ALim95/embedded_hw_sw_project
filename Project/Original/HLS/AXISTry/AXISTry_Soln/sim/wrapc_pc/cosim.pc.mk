...
$(ObjDir)/Test_AXISTry.cpp_pre.cpp.tb.o : Test_AXISTry.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling Test_AXISTry.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/AXISTry.cpp_pre.cpp.tb.o : AXISTry.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling AXISTry.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
