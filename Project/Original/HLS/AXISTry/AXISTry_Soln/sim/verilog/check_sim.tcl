...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.AXISTry.autotvin_S_AXIS_V_data.dat"
         "c.AXISTry.autotvin_S_AXIS_V_last.dat"
         "c.AXISTry.autotvin_M_AXIS_V_data.dat"
         "c.AXISTry.autotvin_M_AXIS_V_last.dat"
         "c.AXISTry.autotvout_M_AXIS_V_data.dat"
         "c.AXISTry.autotvout_M_AXIS_V_last.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.AXISTry.autotvout_M_AXIS_V_data.dat"
         "rtl.AXISTry.autotvout_M_AXIS_V_last.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
