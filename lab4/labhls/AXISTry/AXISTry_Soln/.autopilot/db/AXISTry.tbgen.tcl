set C_TypeInfoList {{ 
"AXISTry" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"S_AXIS": [[], {"reference": "0"}] }, {"M_AXIS": [[], {"reference": "0"}] }],[],""], 
"0": [ "stream<AXIS_wLAST>", {"hls_type": {"stream": [[[[],"1"]],"2"]}}], 
"1": [ "AXIS_wLAST", {"struct": [[],[],[{ "data": [[32], "3"]},{ "last": [[],  {"scalar": "bool"}]}],""]}], 
...
set C_modelArgMapList {[ 
	{ "Name" : "S_AXIS_V_data", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "S_AXIS.V.data","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "M_AXIS_V_data", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "M_AXIS.V.data","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.AXISTry_mul_32ns_bkb_U0", "Parent" : "0"}]}
